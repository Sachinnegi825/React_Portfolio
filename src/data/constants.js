...
export const Bio = {
  ...
  description:
    "I’m a motivated software developer with a passion for programming, graduated in 2023 from Dr. Akhilesh Das Gupta Institute. I’m committed to continuous learning and delivering quality work, eager to contribute and grow in software development.",
...
export const experiences = [
  {
    ...
    desc: [
      "Developed responsive UIs with ReactJS and Next.js, improving performance by 20% through API integrations.",
      "Collaborated with design teams to enhance UI/UX, increasing user engagement by 15%.",
      "Optimized front-end performance using code splitting and lazy loading techniques.",
      "Contributed to a custom design system, improving code maintainability and team productivity",
    ],
